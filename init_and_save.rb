...
puts 'books count = ' + LIBRARY.books.count.to_s
puts 'author count = ' + LIBRARY.authors.count.to_s
puts 'readers count = ' + LIBRARY.readers.count.to_s
puts 'orders count = ' + LIBRARY.orders.count.to_s
